...
{	
	if(projectile.hit.type != DIM3_PROJ_HIT_TYPE_OBJECT) {
	    sound.play("MapGeometryBulletHit", projectile.position, utility.random.getFloat(0.8, 1.2));
	} else {
	    sound.play("EnemyBulletHit", projectile.position, utility.random.getFloat(0.8, 1.2))
	}
